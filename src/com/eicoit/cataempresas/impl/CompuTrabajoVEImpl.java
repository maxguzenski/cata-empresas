...
public class CompuTrabajoVEImpl extends HtmlUnitFormAdapter {

	private static final String HOST = "http://www.computrabajo.com.ve/";
	private static final String FORM_URL = "http://www.computrabajo.com.ve/bt-ofertas.htm";
	private static final String FORM_NAME = "";
	private static final String FILE_NAME = "computrabajo_VE";
	...
	public CompuTrabajoVEImpl(String param) {
		this.param = param;
	}

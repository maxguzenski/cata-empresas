...
public class CompuTrabajoESImpl extends HtmlUnitFormAdapter {

	private static final String HOST = "http://www.computrabajo.com.es/";
	private static final String FORM_URL = "http://www.computrabajo.com.es/bt-ofertas.htm";
	private static final String FORM_NAME = "";
	private static final String FILE_NAME = "computrabajo_ES";
	...
	public CompuTrabajoESImpl(String param) {
		this.param = param;
	}

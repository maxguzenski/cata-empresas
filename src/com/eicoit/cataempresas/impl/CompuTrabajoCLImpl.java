...
public class CompuTrabajoCLImpl extends HtmlUnitFormAdapter {

	private static final String HOST = "http://www.computrabajo.com.cl/";
	private static final String FORM_URL = "http://www.computrabajo.com.cl/bt-ofertas.htm";
	private static final String FORM_NAME = "";
	private static final String FILE_NAME = "computrabajo_CL";
	...
	public CompuTrabajoCLImpl(String param) {
		this.param = param;
	}

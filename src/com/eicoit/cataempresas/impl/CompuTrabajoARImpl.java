...
public class CompuTrabajoARImpl extends HtmlUnitFormAdapter {

	private static final String HOST = "http://www.computrabajo.com.ar/";
	private static final String FORM_URL = "http://www.computrabajo.com.ar/bt-ofertas.htm";
	private static final String FORM_NAME = "";
	private static final String FILE_NAME = "computrabajo_AR";
	...
	public CompuTrabajoARImpl(String param) {
		this.param = param;
	}
